...
# Data
trainloader = data.get_trainloader(args.dataset, args.batch_size, args.shuffle_train_seed)
...
if use_wandb:
    ...
    wandb_name = args.wandb_name or f"{condition}-seed{args.init_seed:02d}"
    settings = {}
